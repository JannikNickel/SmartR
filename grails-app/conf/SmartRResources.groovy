modules = {
    ...
    smartR_all {
        ...
        //Timeseries
        resource url: [plugin: 'smart-r', dir: 'js/smartR/_angular/controllers', file: 'timeseries.js']
        resource url: [plugin: 'smart-r', dir: 'js/smartR/_angular/viz', file: 'd3Timeseries.js']
    }
}
